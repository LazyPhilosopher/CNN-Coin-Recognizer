...
from core.utilities.helper import load_png_as_tensor, threshold_to_black_and_white, apply_rgb_mask, get_directories
...
if __name__ == "__main__":
    catalog_path = Path("coin_catalog/augmented_200")
    samples = [
        "(Czech Republic, 50 Korun, 2008)/1_19.png",
        "(Czech Republic, 1 Koruna, 2018)/1_28.png",
        "(USA, 2.5 Dollar, 1909)/1_7.png",
        "(Great britain, 0.5 Souvereign, 1906)/0_13.png",
        "(Iran, 0.5 Souvereign, 1925)/4_3.png",
        "(Austria-Hungary, 20 Korona, 1893)/0_8.png",
        "(Czech Republic, 10 Korun, 2020)/0_3.png",
        "(France, 2 Franc, 1917)/0_20.png",
        "(Czech Republic, 5 Korun, 2002)/0_17.png",
        "(India, 1 Rupee, 1840)/4_26.png",
        "(Austria-Hungary, 20 Korona, 1893)/0_11.png",
    ]
    ...
    background_deletion_model_path = Path("kunstkammer/background_deletion/trained/coin_full/keras_coin_full_checkpoint.h5")
    background_deletion_model = tf.keras.models.load_model(background_deletion_model_path)
    classification_model_path = Path("kunstkammer/object_recognition/trained/crops_predict/keras_crops_predict.h5")
    ...
    for sample_path in samples:
        ...
        image_small = load_png_as_tensor(full_sample_path, mask_shape)
        ...
        image_full = load_png_as_tensor(full_sample_path, output_shape)
